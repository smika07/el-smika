...
<div class="navbar">
    ...
    <div class="nav-item">
        ...
        <a href="<?php echo $users['role']?>/mapel.php"><button class="button button2">Mapel</button></a>
        <a href="<?php echo $users['role']?>/nilai.php"><button class="button button3">nilai</button></a>
